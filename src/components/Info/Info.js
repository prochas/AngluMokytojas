...
const Info = () => {
  ...
  return (
    <section className="border-t border-b border-[#0000000d] bg-[#00000005] flex flex-col pt-0 lg:pb-14 pb-0 lg:pt-12">
        ...
        >
          {infoBlock.map((item, index) => (
            <React.Fragment key={index}>
              <div
                className="flex flex-col justify-start items-center px-6 gap-x-6 gap-y-3 lg:gap-y-6 lg:py-0 py-5 
             max-md:flex-row max-md:items-center max-md:justify-start max-md:gap-x-7 max-md:text-left"
              >
                {/* Image left */}
                <Image
                  src={item.img}
                  ...
                  className="w-[40px] h-[40px] md:w-[35px] md:h-[35px] sm:w-[50px] sm:h-[50px] flex-shrink-0"
                />
                {/* Text block right */}
                <div className="flex flex-col">
                  <span className="text-[32px] lg:text-[56px] leading-[112%] text-black lg:mb-3 mb-1 lg:text-center text-left">
                    {item.title}
                  </span>
                  <p className="text-md text-[#000000b3] font-semibold lg:text-center text-left">
                    {item.description}
                  </p>
                </div>
              </div>
